...
<body>
	...
	<div class="card">
		<div class="card-body">
			...
			<h6 class="card-subtitle mb-2 text-muted">Board Update</h6>
			<hr class="my-4">
			<form action="${pageContext.request.contextPath}/board/modifyBoard"
				method="post" id="modifyBoard" class="form">
				<input type="hidden" name="boardNo" value="${b.boardNo}">
				<table>
					<tr class="form-group">
						<td><label for="exampleInputEmail1">Title</label></td>
						<td><input type="text" class="form-control" name="boardTitle" id="boardTitle" value="${b.boardTitle }"></td>
					</tr>
					<tr class="form-group">
						<td><label for="exampleInputEmail1">Content</label></td>
						<td><textarea class="form-control" cols="30" rows="10" name="boardContent" id="boardContent">${b.boardContent }</textarea></td>
					</tr>
					<tr class="form-group">
				...
				<div class="btn-group">
					<button type="button" name="addBoardBt" id="modifyBoardBt"
